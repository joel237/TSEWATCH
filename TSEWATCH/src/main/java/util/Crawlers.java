...
//			avis.print();
//		}
		//crawler.proxiLegalesCrawler("info");
	 ...
	 * 
	 */
	public void proxiLegalesCrawler(String filtre) {
		//define the url of the site
		String urlProxi = "https://www.proxilegales.fr/publisher_portail/public/annonce/afficherAnnonces.jsp;jsessionid=52E4BDCF7F89FB5D5DF58052EAEFA420";
		...
		/*
		 * 
bDisplaySearchEngine: false
bLaunchSearch: true
sActionMarchePersonneItem: 
sMarchePersonneItemListMarche: 
sMarchePersonneItemListMarcheAll: 
filtre: info
sSEOperatorValue: OR
filtreType: marche.ALL_REF
raisonSociale: 
iIdDepartement: 
type_avis: tout
iIdMarcheType: 
...
se_tsEndDate:*/
		...
		Elements eles_link = doc.getElementsByAttributeValueStarting("onclick", "javascript:OuvrirPopup");
		...
		for(String link : listHTML) {
			...
			listLinks.add("https://www.proxilegales.fr"+ListString[1]);
		}
		
		//get the titres from the HTML data
//		Elements eles_titre = doc.getElementsContainingText("Objet :");
...
//		}
	...
	public ArrayList<Avis> marchepublicsInfoCrawler(String IDR, String dateParution) {
		 ...
		 * 	IDE: EC
			...
			listeCPV: 
			IDP: X
			IDR: 1,3,7,15,26,38,42,43,63,69,73,74
			txtLibre: 
			txtLibreAcheteur: 
			txtLibreVille: 
			txtLibreLieuExec: 
		...
		//get the links from the HTML data
		Elements eles_links = doc.getElementsByAttributeValueStarting("href","index.cfm?fuseaction=pub.affPublication");
...
//		}
	 ...
	 * @author ZHI
	 * @param the location, the time from (debut) to (fin),and the number of the pages(including the first page)
	 * @return list of the avis
	 * 
	 ...
	 * ...
	 */
 	public ArrayList<Avis> franceMarcheCrawler(String localisation,String date_parution_debut,String date_parution_fin,int pageNum) {
